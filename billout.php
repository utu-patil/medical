  ...
  <div class="content2">
    ...
    <div class="well well-sm" style="width: 77%;margin: auto;">
      <table class="table table-bordered table-striped">
        ...
        <?php
        $discountAmount = ($total * $_POST['discount']) / 100;
        ?>
        
        <tr>
          <td colspan="3" style="text-align: right;">Discount (<?php echo $_POST['discount']; ?>%)</td><th style="border-bottom: 1px solid blue;"><?php echo $discountAmount; ?></th>
        </tr>

        <!-- Final Total after Discount -->
        <tr>
          <td colspan="3" style="text-align: right;border-right: 1px solid blue">Total After Discount</td><th style="border: 1px solid blue;"><?php echo $total - $discountAmount; ?></th>
        </tr>
...
if (!$con->query("INSERT INTO sold (name, contact, discount, amount, item, userId) 
                  VALUES ('$_POST[name]', '$_POST[contact]', '$_POST[discount]', '$total', '$i', '$_SESSION[userId]')")) {
  echo "Error is:" . $con->error;
}

// Clear the bill session
